...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "qct.ipc", false, filepath.Join(os.TempDir(), "qct.ipc")},
		{"data", "qct.ipc", false, "data/qct.ipc"},
		{"data", "./qct.ipc", false, "./qct.ipc"},
		{"data", "/qct.ipc", false, "/qct.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "qct.ipc", true, `\\.\pipe\qct.ipc`},
		{"data", "qct.ipc", true, `\\.\pipe\qct.ipc`},
		{"data", `\\.\pipe\qct.ipc`, true, `\\.\pipe\qct.ipc`},
	}
