...
// account array.
func checkStateAccounts(t *testing.T, db qctdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db qctdb.Database, root common.Hash) error {
...
func checkStateConsistency(db qctdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(qctdb.Database), srcRoot)
