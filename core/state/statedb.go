...
// StateDBs within the quickchain protocol are used to store anything
...
func (self *StateDB) Copy() *StateDB {
	...
	for addr := range self.journal.dirties {
		// As documented [here](https://github.com/quickchain/quickchain/pull/16485#issuecomment-380438527),
