...
import (
	...
	"github.com/quickchain/quickchain/common/mclock"
	"github.com/quickchain/quickchain/consensus"
	"github.com/quickchain/quickchain/consensus/dpos"
	//"github.com/quickchain/quickchain/consensus/bft"
	//"github.com/quickchain/quickchain/consensus/dbft"
...
type BlockChain struct {
	...
	db     qctdb.Database // Low level persistent database to store final content in
...
// Processor.
func NewBlockChain(db qctdb.Database, cacheConfig *CacheConfig, chainConfig *params.ChainConfig, engine consensus.Engine, vmConfig vm.Config) (*BlockChain, error) {
	if cacheConfig == nil {
...
func (bc *BlockChain) InsertReceiptChain(blockChain types.Blocks, receiptChain []types.Receipts) (int, error) {
	...
	for i, block := range blockChain {
		...
		if batch.ValueSize() >= qctdb.IdealBatchSize {
